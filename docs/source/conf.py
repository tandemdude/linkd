...
project = "linkd"
copyright = "2025-present, tandemdude"
author = "tandemdude"

with open("../../linkd/__init__.py") as fp:
    file = fp.read()
...
ogp_site_name = "Linkd Documentation"

add_module_names = False
modindex_common_prefix = ["linkd."]
